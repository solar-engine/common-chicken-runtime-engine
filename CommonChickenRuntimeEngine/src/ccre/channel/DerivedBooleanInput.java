 ...
 * other channels.
 *
 * <code>BooleanInput input = new DerivedBooleanInput(... some other inputs to watch ...) {<br>&nbsp;&nbsp;&nbsp;&nbsp;protected boolean apply() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return // some value<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>}</code>
 *
 ...
 * the value of the BooleanInput is updated.
 *
...
public abstract class DerivedBooleanInput extends AbstractUpdatingInput implements BooleanInput {
    ...
    /**
     * Creates a derived BooleanInput that may update when anything in
    ...
    /**
     * Implement this to specify the value held by the derived BooleanInput.
     *
