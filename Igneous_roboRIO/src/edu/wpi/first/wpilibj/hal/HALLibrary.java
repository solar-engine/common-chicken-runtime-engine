...
public class HALLibrary /* implements Library */ {
     ...
     * 
     * @deprecated use the safer methods
     * {@link #cleanNotifier(com.sun.jna.Pointer, java.nio.IntBuffer)} and
     ...
     * 
     * @deprecated use the safer methods
     * {@link #deleteMutex(edu.wpi.first.wpilibj.hal.HALLibrary.MUTEX_ID)} and
     * {@link #deleteMutex(com.sun.jna.Pointer)} instead
     */
    //@Deprecated
     ...
     * 
     * @deprecated use the safer methods
     * {@link #giveMutex(edu.wpi.first.wpilibj.hal.HALLibrary.MUTEX_ID)} and
     * {@link #giveMutex(com.sun.jna.Pointer)} instead
     */
    //@Deprecated
     ...
     * 
     * @deprecated use the safer methods
     * {@link #restartTask(edu.wpi.first.wpilibj.hal.HALLibrary.TASK)} and
     * {@link #restartTask(com.sun.jna.Pointer)} instead
     */
    //@Deprecated
     ...
     * 
     * @deprecated use the safer methods
     * {@link #deleteTask(edu.wpi.first.wpilibj.hal.HALLibrary.TASK)} and
     * {@link #deleteTask(com.sun.jna.Pointer)} instead
     */
    //@Deprecated
     ...
     * 
     * @deprecated use the safer methods
     * {@link #isTaskReady(edu.wpi.first.wpilibj.hal.HALLibrary.TASK)} and
     * {@link #isTaskReady(com.sun.jna.Pointer)} instead
     */
    //@Deprecated
     ...
     * 
     * @deprecated use the safer methods
     * {@link #isTaskSuspended(edu.wpi.first.wpilibj.hal.HALLibrary.TASK)} and
     * {@link #isTaskSuspended(com.sun.jna.Pointer)} instead
     */
    //@Deprecated
     ...
     * 
     * @deprecated use the safer methods
     * {@link #suspendTask(edu.wpi.first.wpilibj.hal.HALLibrary.TASK)} and
     * {@link #suspendTask(com.sun.jna.Pointer)} instead
     */
    //@Deprecated
     ...
     * 
     * @deprecated use the safer methods
     * {@link #resumeTask(edu.wpi.first.wpilibj.hal.HALLibrary.TASK)} and
     * {@link #resumeTask(com.sun.jna.Pointer)} instead
     */
    //@Deprecated
     ...
     * 
     * @deprecated use the safer methods
     * {@link #verifyTaskID(edu.wpi.first.wpilibj.hal.HALLibrary.TASK)} and
     * {@link #verifyTaskID(com.sun.jna.Pointer)} instead
     */
    //@Deprecated
     ...
     * {@link #getFPGARevision(com.sun.jna.ptr.IntByReference)} instead
     */
    //@Deprecated
     ...
     * 
     * @deprecated use the safer methods
     * {@link #getFPGATime(java.nio.IntBuffer)} and
     * {@link #getFPGATime(com.sun.jna.ptr.IntByReference)} instead
     */
    //@Deprecated
     ...
     * GlobalInt(HALLibrary.JNA_NATIVE_LIB, "HAL_taskLib_ILLEGAL_OPTIONS");
     * public static final GlobalInt HAL_memLib_NOT_ENOUGH_MEMORY = new
     ...
     * GlobalInt(HALLibrary.JNA_NATIVE_LIB, "solenoid_kNumDO7_0Elements");
     * public static final GlobalInt interrupt_kNumSystems = new
     ...
     */
    /*
     * public static class TASK extends PointerType { public TASK(Pointer
     * address) { super(address); } public TASK() { super(); } }; public static
     * class MUTEX_ID extends PointerType { public MUTEX_ID(Pointer address) {
     ...
     * super(address); } public MULTIWAIT_ID() { super(); } }; public static
     * class SEMAPHORE_ID extends PointerType { public SEMAPHORE_ID(Pointer
     * address) { super(address); } public SEMAPHORE_ID() { super(); } };
     */
}
