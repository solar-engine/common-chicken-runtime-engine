...
public final class Entity {
    ...
    public void render(Graphics g) {
        ...
        Rendering.drawEntityText(g, centerX - width + 1, centerY - height + 1, new String[] { represented.path, CluckNode.rmtToString(represented.type) });
        ...
        case RMT_BOOLOUTP:
            ...
            if (currentValue != null) {
                ...
                g.drawString(cur ? "TRUE" : "FALSE", cur ? centerX - g.getFontMetrics().stringWidth("TRUE") : centerX, centerY + height - g.getFontMetrics().getDescent());
            }
            break;
        case RMT_FLOATOUTP:
            if (currentValue == null) {
