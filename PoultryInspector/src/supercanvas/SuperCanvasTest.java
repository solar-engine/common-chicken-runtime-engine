...
public class SuperCanvasTest extends javax.swing.JFrame {
    ...
    public SuperCanvasTest() {
        ...
        /*
         * EventStatus event = new EventStatus(); BooleanStatus bool = new
         * BooleanStatus(); FloatStatus num = new FloatStatus();
         * ArrayList<SuperCanvasComponent> components = new
         * ArrayList<SuperCanvasComponent>(); components.add(new
         * EventControlComponent(100, 50, "control/event", event));
         * components.add(new BooleanControlComponent(100, 200,
         * "control/boolean", bool)); components.add(new
         * FloatControlComponent(100, 350, "control/float", num));
         * components.add(new EventDisplayComponent(300, 50, "display/event",
         * event)); components.add(new BooleanDisplayComponent(300, 200,
         * "display/boolean", bool)); components.add(new
         * FloatDisplayComponent(300, 350, "display/float", num));
         * ArrayList<PaletteEntry> entries = new ArrayList<PaletteEntry>();
         * ListPaletteComponent lpc = new ListPaletteComponent(100, 100,
         * entries); for (SuperCanvasComponent c : components) {
